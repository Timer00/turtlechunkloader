...
execute as @e[type=minecraft:marker,tag=turtle] at @s if block ~1 ~ ~ computercraft:turtle_normal run tp @s ~1 ~1 ~
execute as @e[type=minecraft:marker,tag=turtle] at @s if block ~-1 ~ ~ computercraft:turtle_normal run tp @s ~-1 ~1 ~
execute as @e[type=minecraft:marker,tag=turtle] at @s if block ~ ~ ~1 computercraft:turtle_normal run tp @s ~ ~1 ~1
execute as @e[type=minecraft:marker,tag=turtle] at @s if block ~ ~ ~-1 computercraft:turtle_normal run tp @s ~ ~1 ~-1
execute as @e[type=minecraft:marker,tag=turtle] at @s if block ~ ~-1 ~ computercraft:turtle_normal run tp @s ~ ~-1 ~
